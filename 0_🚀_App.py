...
def render_preventivi_page():
    ...
    with tab_new:
        ...
        # FIX: Reset automatico se la tabella ha colonne vecchie
        ...
        edited_df = st.data_editor(
            ...
            use_container_width=True,
            key=f"editor_prev_{tipo_prev}_v3"
        )
        ...
        # DEFINIZIONE CSS SEPARATA (Per evitare errori di sintassi con f-string)
        # Usiamo una stringa normale, non una f-string, così le parentesi {} restano singole.
        css_style = """
        ...
        # F-STRING FINALE (Inseriamo css_style come variabile)
        raw_html = f"""
        <!DOCTYPE html>
        <html>
        <head>
