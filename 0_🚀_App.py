...
def render_organigramma():
    ...
    with c3: 
        ...
        """, unsafe_allow_html=True)
    with c4: 
        st.markdown("""# --- 7. GESTIONE PREVENTIVI (LAYOUT FILE WORD SISMA) ---
def render_preventivi_page():
    ...
    with tab_new:
        ...
        # --- FIX: CONTROLLO STRUTTURA DATAFRAME ---
        # Se non esiste la chiave O se la colonna "Descrizione Estesa" manca (vecchia versione in cache) -> RESET
        ...
        edited_df = st.data_editor(
            ...
            use_container_width=True,
            key=f"editor_prev_{tipo_prev}_v2" # Cambio key per forzare refresh widget
        )
        ...
        <div class="page">
            ...
            <div style="font-size: 10pt; text-align: justify; margin-top: 30px;">
                ...
                <ul style="padding-left: 20px; margin: 0;">
                    ...
                    <li style="margin-bottom: 5px;">Eventuali indagini aggiuntive... (omissis standard) ...approvate dalla Committenza.</li>
                    <li style="margin-bottom: 5px;">Nel presente preventivo non sono altresì conteggiate eventuali opere provvisionali...</li>
                    <li style="margin-bottom: 5px;">Le tempistiche previste per le varie attività...</li>
                    <li style="margin-bottom: 5px;">Per ottimizzare le tempistiche previste...</li>
                    <li style="margin-bottom: 5px;">Qualora venga accettato, il presente preventivo...</li>
                    ...
                    <li>La Società SISMA srl... si riserverà il diritto di utilizzare gli elaborati...</li>
                </ul>
